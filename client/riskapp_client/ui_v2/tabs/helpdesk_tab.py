...
from riskapp_client.ui_v2.ui.ui_helpdesk_tab import Ui_HelpDeskTab
...
class HelpDeskTab(QWidget):
    ...
    def __init__(
        ...
        *,
        ...
        self.ticket_category.setToolTip(
            "Type of ticket: bug, question, feature request, access, or other"
        )
        self.ticket_priority.setToolTip("Urgency: low, medium, high, or critical")
        self.ticket_status.setToolTip(
        ...
        self.ui.filter_priority.currentTextChanged.connect(
            lambda _: on_filter_changed()
        )
