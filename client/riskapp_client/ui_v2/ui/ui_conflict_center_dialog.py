...
class Ui_conflict_center_dialog(object):
    def setupUi(self, conflict_center_dialog):
        ...
        self.merge_btn = QPushButton(conflict_center_dialog)
        self.merge_btn.setObjectName(u"merge_btn")
        self.merge_btn.setEnabled(False)
        self.merge_btn.setMinimumSize(QSize(110, 0))

        self.actions_layout.addWidget(self.merge_btn)

        self.merge_later_spacer = QSpacerItem(15, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)

        self.actions_layout.addItem(self.merge_later_spacer)
        ...
        self.conflict_close_buttons.setStyleSheet(u"QPushButton { min-width: 90px; }")
        ...
        QWidget.setTabOrder(self.use_server_btn, self.merge_btn)
        QWidget.setTabOrder(self.merge_btn, self.later_btn)
    ...
    def retranslateUi(self, conflict_center_dialog):
        conflict_center_dialog.setWindowTitle(QCoreApplication.translate("conflict_center_dialog", u"Synchronization conflicts", None))
#if QT_CONFIG(accessibility)
        conflict_center_dialog.setAccessibleName("")
#endif // QT_CONFIG(accessibility)
        self.intro_label.setText(QCoreApplication.translate("conflict_center_dialog", u"These items changed both locally and on the server. Select one, compare the copies, then choose which version should win.", None))
        ___qtablewidgetitem = self.conflict_table.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("conflict_center_dialog", u"Type", None))
        ___qtablewidgetitem1 = self.conflict_table.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("conflict_center_dialog", u"Item", None))
        ___qtablewidgetitem2 = self.conflict_table.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("conflict_center_dialog", u"Operation", None))
        ___qtablewidgetitem3 = self.conflict_table.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("conflict_center_dialog", u"Reason", None))
        ___qtablewidgetitem4 = self.conflict_table.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("conflict_center_dialog", u"Server version", None))
        ___qtablewidgetitem5 = self.conflict_table.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("conflict_center_dialog", u"Server updated", None))
#if QT_CONFIG(tooltip)
        self.conflict_table.setToolTip(QCoreApplication.translate("conflict_center_dialog", u"Select a conflict to compare the local and server copies", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(accessibility)
        self.conflict_table.setAccessibleName(QCoreApplication.translate("conflict_center_dialog", u"Unresolved synchronization conflicts", None))
#endif // QT_CONFIG(accessibility)
        self.local_group.setTitle(QCoreApplication.translate("conflict_center_dialog", u"Local copy", None))
#if QT_CONFIG(accessibility)
        self.local_copy.setAccessibleName(QCoreApplication.translate("conflict_center_dialog", u"Local record data", None))
#endif // QT_CONFIG(accessibility)
        self.local_copy.setPlaceholderText(QCoreApplication.translate("conflict_center_dialog", u"Select a conflict to view the local copy.", None))
        self.server_group.setTitle(QCoreApplication.translate("conflict_center_dialog", u"Server copy", None))
#if QT_CONFIG(accessibility)
        self.server_copy.setAccessibleName(QCoreApplication.translate("conflict_center_dialog", u"Server record data", None))
#endif // QT_CONFIG(accessibility)
        self.server_copy.setPlaceholderText(QCoreApplication.translate("conflict_center_dialog", u"Select a conflict to view the server copy.", None))
#if QT_CONFIG(tooltip)
        self.keep_mine_btn.setToolTip(QCoreApplication.translate("conflict_center_dialog", u"Queue your local copy again against the latest known server version", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(accessibility)
        self.keep_mine_btn.setAccessibleName(QCoreApplication.translate("conflict_center_dialog", u"Keep my local version", None))
#endif // QT_CONFIG(accessibility)
        self.keep_mine_btn.setText(QCoreApplication.translate("conflict_center_dialog", u"Keep mine", None))
#if QT_CONFIG(tooltip)
        self.use_server_btn.setToolTip(QCoreApplication.translate("conflict_center_dialog", u"Discard this queued local write and replace it with the saved server copy", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(accessibility)
        self.use_server_btn.setAccessibleName(QCoreApplication.translate("conflict_center_dialog", u"Use the server version", None))
#endif // QT_CONFIG(accessibility)
        self.use_server_btn.setText(QCoreApplication.translate("conflict_center_dialog", u"Use server", None))
#if QT_CONFIG(tooltip)
        self.merge_btn.setToolTip(QCoreApplication.translate("conflict_center_dialog", u"Choose values from both copies for editable fields", None))
#endif // QT_CONFIG(tooltip)
        self.merge_btn.setText(QCoreApplication.translate("conflict_center_dialog", u"Merge fields\u2026", None))
#if QT_CONFIG(tooltip)
        self.later_btn.setToolTip(QCoreApplication.translate("conflict_center_dialog", u"Leave every unresolved conflict blocked", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(accessibility)
        self.later_btn.setAccessibleName(QCoreApplication.translate("conflict_center_dialog", u"Decide later", None))
#endif // QT_CONFIG(accessibility)
        self.later_btn.setText(QCoreApplication.translate("conflict_center_dialog", u"Later", None))
    # retranslateUi
